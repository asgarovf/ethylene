...
export var useBlockTimestamp = function () {
    var provider = useTypedSelector(function (state) { return state.account.provider; });
    var fetchBlockTimestamp = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return { fetchBlockTimestamp: fetchBlockTimestamp };
};
